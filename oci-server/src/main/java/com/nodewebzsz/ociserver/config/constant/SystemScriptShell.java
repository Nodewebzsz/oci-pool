package com.nodewebzsz.ociserver.config.constant;
...
public class SystemScriptShell {
    ...
    public static final String vcnName = "oci-pool-pro-vcn";

    public static final String internetGatewayName = "oci-pool-pro-internet-gateway";

    public static final String subnetName = "oci-pool-pro-subnet";

    public static final String bootVolumeName = "oci-pool-pro-boot-volume";

    public static final String networkSecurityGroupName = "oci-pool-pro-nsg";
