...
import static com.nodewebzsz.ociserver.config.exception.ErrorCode.CAPACITY;
import static com.nodewebzsz.ociserver.config.exception.ErrorCode.CAPACITY_HOST;
import static com.nodewebzsz.ociserver.config.exception.ErrorCode.DISK_SIZE_EXCEEDED;
import static com.nodewebzsz.ociserver.config.exception.ErrorCode.LIMIT_EXCEEDED;
import static com.nodewebzsz.ociserver.config.exception.ErrorCode.NOT_AUTH;
import static com.nodewebzsz.ociserver.config.exception.ErrorCode.NOT_AUTH_NOT_FUND;
import static com.nodewebzsz.ociserver.config.exception.ErrorCode.TOO_MANY_REQUESTS;
...
public class OciLogBuilder {
    ...
    /**
    * @Description: 开机日志异常
    * @Param: [long, java.lang.String, int, com.nodewebzsz.ociserver.pojo.domain.dto.User, boolean, java.lang.Exception, com.nodewebzsz.ociserver.pojo.domain.dto.OracleInstanceDetail]
