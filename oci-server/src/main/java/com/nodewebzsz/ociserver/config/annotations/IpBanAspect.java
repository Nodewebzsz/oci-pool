package com.nodewebzsz.ociserver.config.annotations;

import com.nodewebzsz.dao.entity.BanRecord;
import com.nodewebzsz.dao.repository.BanRecordRepository;
import com.nodewebzsz.ociserver.config.exception.IpBannedException;
...
public class IpBanAspect {
    ...
    @Around("@within(com.nodewebzsz.ociserver.config.annotations.CheckIpBan) || @annotation(com.nodewebzsz.ociserver.config.annotations.CheckIpBan)")
