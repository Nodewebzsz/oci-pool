package com.nodewebzsz.ociserver.config.socker;

import cn.hutool.json.JSONUtil;
import com.nodewebzsz.dao.entity.CloudSshConn;
import com.nodewebzsz.dao.entity.InstanceDetails;
import com.nodewebzsz.dao.entity.TemInstance;
import com.nodewebzsz.dao.entity.Tenant;
import com.nodewebzsz.dao.repository.CloudSshConnRepository;
import com.nodewebzsz.dao.repository.TenantRepository;
import com.nodewebzsz.ocicommon.enums.RegionEnum;
import com.nodewebzsz.ocicommon.param.ScriptResult;
import com.nodewebzsz.ocicommon.utils.JschUtils;
import com.nodewebzsz.ocicommon.utils.PasswordGenerator;
import com.nodewebzsz.ocicommon.utils.PingUtil;
...
import com.nodewebzsz.ociserver.config.event.InstanceBackUpEvent;
...
import com.nodewebzsz.ociserver.pojo.response.InstanceDetailsRes;
import com.nodewebzsz.ociserver.pojo.response.TmpInstanceResponse;
import com.nodewebzsz.ociserver.service.InstanceDetailsService;
import com.nodewebzsz.ociserver.service.OciSshConnService;
import com.nodewebzsz.ociserver.service.OpenApiService;
import com.nodewebzsz.ociserver.service.oracle.OracleCloudService;
import com.nodewebzsz.ociserver.service.SecurityRuleService;
import com.nodewebzsz.ociserver.service.TemInstanceService;
import com.nodewebzsz.ociserver.service.TenantService;
import com.nodewebzsz.ociserver.utils.oracle.OciObjectStorageUtil;
import com.nodewebzsz.ociserver.utils.oracle.OciBackUpUtils;
...
import static com.nodewebzsz.ocicommon.enums.RegionEnum.getNotSupportHelp;
import static com.nodewebzsz.ocicommon.enums.RegionEnum.getRegionCode;
import static com.nodewebzsz.ocicommon.template.MessageTemplate.MESSAGE_RESCUE_SUCCESS_TEMPLATE;
import static com.nodewebzsz.ocicommon.utils.JschUtils.DF_SCRIPT;
import static com.nodewebzsz.ocicommon.utils.JschUtils.UPGRADE_AND_INIT_SCRIPT;
import static com.nodewebzsz.ocicommon.utils.JschUtils.changeRootPassword;
import static com.nodewebzsz.ocicommon.utils.JschUtils.enableRootLogin;
import static com.nodewebzsz.ocicommon.utils.JschUtils.executeOciRescueCommands2;
import static com.nodewebzsz.ocicommon.utils.JschUtils.getRescueStatus;
import static com.nodewebzsz.ocicommon.utils.JschUtils.verifyPasswordChange;
import static com.nodewebzsz.ocicommon.utils.PasswordGenerator.HELP_INIT_PASSWORD;
import static com.nodewebzsz.ociserver.config.constant.GenPojoUtils.bootPojo;
import static com.nodewebzsz.ociserver.utils.oracle.OciBackUpUtils.createBootVolumeBackup;
import static com.nodewebzsz.ociserver.utils.oracle.OciBackUpUtils.createBootVolumeFromBackup;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.DEFAULT_PASSWD;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.cloneBootVolumeFromBootVolume;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.deleteBootVolume;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.getAvailabilityDomainByInstanceId;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.getBootVolume;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.getInstanceById;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.getProvider;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.isBootVolumeTerminated;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.terminateBootVolume;
