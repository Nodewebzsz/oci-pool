...
import com.nodewebzsz.ociserver.job.AiChatHistoryCleanupJob;
import com.nodewebzsz.ociserver.job.BootInstanceRefreshJob;
import com.nodewebzsz.ociserver.job.MultipartUploadCleanupJob;
import com.nodewebzsz.ociserver.job.CheckLiveJob;
import com.nodewebzsz.ociserver.job.CheckOfflineInstanceJob;
import com.nodewebzsz.ociserver.job.CreateInstanceJob;
import com.nodewebzsz.ociserver.job.InstanceSyncJob;
import com.nodewebzsz.ociserver.job.InstanceTrafficJob;
import com.nodewebzsz.ociserver.job.LoadRegionJob;
import com.nodewebzsz.ociserver.job.MonitorFlashHeartbeatJob;
import com.nodewebzsz.ociserver.job.PingConnTimeJob;
import com.nodewebzsz.ociserver.job.SslCertJob;
import com.nodewebzsz.ociserver.job.VersionCheckJob;
...
import static com.nodewebzsz.ocicommon.constant.TaskService.ACCOUNT_LIVE_CHECK_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.BOOT_INSTANCE_REFRESH_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.CREATE_INSTANCE_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.INSTANCE_SYNC_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.INSTANCE_TRAFFIC_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.LOAD_REGION_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.MONITOR_CHECK_OFFLINE_INSTANCE_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.AI_CHAT_HISTORY_CLEANUP_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.MULTIPART_UPLOAD_CLEANUP_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.MONITOR_FLASH_HEARTBEAT_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.PING_CON_TIME_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.SSL_CERT_TASK;
import static com.nodewebzsz.ocicommon.constant.TaskService.VERSION_CHECK_TASK;
