...
import com.nodewebzsz.ociserver.service.QuickDdService;
...
import com.nodewebzsz.ociserver.pojo.request.UpdateConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.UpdateNameRequest;
import com.nodewebzsz.ociserver.pojo.request.UpdateRemarkRequest;
import com.nodewebzsz.ociserver.pojo.request.UpdateVolumeDefRequest;
...
public class OciController  extends BaseController{
    ...
    */
    ...
    /**
    * @Description: 修改实例名称
    * @Param: [com.nodewebzsz.ociserver.request.UpdateNameRequest]
