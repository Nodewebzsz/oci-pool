...
import com.nodewebzsz.ocimonitor.service.MonitorDeployService;
import com.nodewebzsz.ociserver.config.socker.MonitorWebSocketHandler;
...
import static com.nodewebzsz.ocicommon.utils.IpUtils.getPublicIp2;
...
public class MonitorApiController extends BaseController{
    ...
    * @Param: [com.nodewebzsz.ocicommon.param.monitor.MonitorReportDTO]
    * @return: com.nodewebzsz.ocicommon.param.ApiResponse
    * @Author: renyx
    * @Date: 2/5/26 2:20 PM
    */
    @PostMapping("/report")
