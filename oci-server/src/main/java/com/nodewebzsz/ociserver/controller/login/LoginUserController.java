...
import com.nodewebzsz.ociserver.config.annotations.CheckLoginUser;
import com.nodewebzsz.ociserver.config.context.UserContext;
import com.nodewebzsz.ociserver.config.init.Init;
...
import com.nodewebzsz.ociserver.pojo.request.RegisterRequest;
import com.nodewebzsz.ociserver.pojo.request.UpdateUserRequest;
...
public class LoginUserController  extends BaseController {
    ...
    public ResponseEntity<?> updateUser(@RequestBody UpdateUserRequest request) {
        try {
            String currentUsername = com.nodewebzsz.ociserver.config.context.UserContext.getUsername();
