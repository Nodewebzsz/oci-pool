...
import com.nodewebzsz.ociserver.config.exception.OciExceptionFactory;
import com.nodewebzsz.ociserver.pojo.domain.query.BootInstanceQuery;
...
import com.nodewebzsz.ociserver.pojo.request.ImageInfoReq;
import com.nodewebzsz.ociserver.pojo.request.ResetOciPassRequest;
import com.nodewebzsz.ociserver.pojo.request.UpdateCustomNameRequest;
import com.nodewebzsz.ociserver.pojo.request.UpdatePasswordPolicyRequest;
import com.nodewebzsz.ociserver.pojo.response.PasswordPolicyDetail;
import com.nodewebzsz.ociserver.pojo.response.RegionSubscriptionResult;
...
import com.nodewebzsz.ociserver.pojo.request.CreateUserRequest;
import com.nodewebzsz.ociserver.pojo.request.DeleteBootVolumeReq;
...
import com.nodewebzsz.ociserver.pojo.response.BootInstanceRes;
import com.nodewebzsz.ociserver.pojo.response.BootVolumeRes;
import com.nodewebzsz.ociserver.pojo.response.OciGroupResp;
import com.nodewebzsz.ociserver.pojo.response.TenantResp;
import com.nodewebzsz.ociserver.pojo.response.TrafficAlertResponse;
...
import com.nodewebzsz.ociserver.service.TrafficAlertService;
...
import com.nodewebzsz.ociserver.utils.oracle.notify.NotificationUtils;
...
public class TenantController extends BaseController{
    ...
    */
    ...
    /**
    * @Description: 抢机配置
    * @Param: [com.nodewebzsz.dao.entity.BootInstance, org.springframework.web.servlet.mvc.support.RedirectAttributes, org.springframework.ui.Model, javax.servlet.http.HttpServletRequest]
    ...
    * @Param: [com.nodewebzsz.ociserver.request.UpdateVolumeDefRequest]
    * @return: org.springframework.http.ResponseEntity<com.nodewebzsz.ociserver.response.ApiResponse>
    * @Author: nodewebzsz
    ...
    */
    ...
    /**
     * 校验 API 导入弹窗中的自定义名称。
     * 该检查使用数据库权威数据；前端列表可能分页或尚未刷新，不能作为唯一依据。
     */
    @GetMapping("/checkCustomName")
    @ResponseBody
    public ResponseEntity<Map<String, Object>> checkCustomName(
            @RequestParam String name,
            @RequestParam(defaultValue = "1") Integer cloudType,
            @RequestParam(required = false) Long excludeTenantId,
            @RequestParam(required = false) String excludeTenancy) {
        Map<String, Object> result = new HashMap<>();
        if (name == null || name.trim().isEmpty()) {
            result.put("exists", false);
            return ResponseEntity.ok(result);
        }
        boolean exists = tenantService.existsCustomName(name, cloudType, excludeTenantId, excludeTenancy);
    ...
    * @Param: [java.lang.String, com.nodewebzsz.ociserver.request.BootVolumeUpdateRequest]
    * @return: org.springframework.http.ResponseEntity<?>
    * @Author nodewebzsz
