...
import com.nodewebzsz.ociserver.pojo.request.AbortMultipartUploadRequest;
import com.nodewebzsz.ociserver.pojo.request.CommitMultipartUploadRequest;
import com.nodewebzsz.ociserver.pojo.request.CreateBucketRequest;
import com.nodewebzsz.ociserver.pojo.request.DeleteBucketRequest;
import com.nodewebzsz.ociserver.pojo.request.DeleteObjectRequest;
import com.nodewebzsz.ociserver.pojo.request.InitiateMultipartUploadRequest;
import com.nodewebzsz.ociserver.pojo.request.PresignedUrlRequest;
import com.nodewebzsz.ociserver.pojo.response.BucketVO;
import com.nodewebzsz.ociserver.pojo.response.InitiateMultipartUploadVO;
import com.nodewebzsz.ociserver.pojo.response.NamespaceVO;
import com.nodewebzsz.ociserver.pojo.response.ObjectVO;
import com.nodewebzsz.ociserver.pojo.response.PresignedUrlVO;
import com.nodewebzsz.ociserver.pojo.response.MultipartUploadRecordVO;
import com.nodewebzsz.ociserver.pojo.response.UploadPartVO;
import com.nodewebzsz.ociserver.service.OciMultipartUploadService;
...
public class OciObjectStorageController extends BaseController {
    ...
    @Resource
    com.nodewebzsz.ociserver.mock.MockDataService mockDataService;
    ...
    public ApiResponse initiateMultipartUpload(@RequestBody @Valid InitiateMultipartUploadRequest req) {
        try {
            ...
            List<com.nodewebzsz.dao.entity.OciMultipartUploadRecord> oldRecords =
                    multipartUploadService.findActiveUploads(req.getTenantId(), req.getBucketName(), req.getObjectName());
            for (com.nodewebzsz.dao.entity.OciMultipartUploadRecord old : oldRecords) {
