package com.nodewebzsz.ociserver.third.openApi.controller;
...
import com.nodewebzsz.ociserver.third.openApi.annotation.RequireApiToken;
import com.nodewebzsz.ociserver.third.openApi.request.AiChatRequest;
...
@RestController
@RequestMapping("/oci-pool/open-api/v1")
@Tag(name = "OCI-POOL OPEN-API", description = "开放API接口")
@Slf4j
