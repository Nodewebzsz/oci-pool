...
import com.nodewebzsz.ociserver.pojo.domain.dto.OciClassLoaderPojo;
import com.nodewebzsz.ociserver.utils.oracle.OciClassLoader;
import com.nodewebzsz.ociserver.service.oracle.BootVolumeService;
...
import static com.nodewebzsz.ociserver.config.constant.SystemScriptShell.getShell;
import static com.nodewebzsz.ociserver.pojo.enums.OperationSystemEnum.UBUNTU_20_04;
...
public class BootVolumeServiceImpl implements BootVolumeService {
    ...
    private static final String ROOT_PASSWORD = "oci-pool"; // 临时root密码，首次登录后请更改
