...
import com.nodewebzsz.dao.entity.OciComputerInfo;
import com.nodewebzsz.dao.entity.OpenBootLock;
...
import com.nodewebzsz.dao.repository.OpenBootLockRepository;
...
import com.nodewebzsz.ociserver.config.event.OracleInstanceSuccessEvent;
import com.nodewebzsz.ociserver.config.OciLogBuilder;
...
import com.nodewebzsz.ociserver.service.BootTotalInstanceService;
import com.nodewebzsz.ociserver.service.OpenSuccessService;
import com.nodewebzsz.ociserver.utils.oracle.OciComputerUtils;
...
import static com.nodewebzsz.ociserver.config.constant.SystemScriptShell.*;
import static com.nodewebzsz.ociserver.config.exception.ErrorCode.*;
...
public class OracleCloudService {
    ...
    /**
    * @Description: 直接执行创建
    * @Param: [long, com.nodewebzsz.dao.entity.Tenant, com.nodewebzsz.ociserver.pojo.domain.dto.User, com.nodewebzsz.ociserver.pojo.domain.dto.OracleInstanceDetail]
    * @return: com.nodewebzsz.ociserver.pojo.domain.dto.OracleInstanceDetail
    * @Author: nodewebzsz
    ...
    */
    ...
    private String generateConfigToken(String taskId, LaunchInstanceDetails details) {
        StringBuilder tokenBuilder = new StringBuilder("instance-oci-pool-");
