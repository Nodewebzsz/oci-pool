package com.nodewebzsz.ociserver.service.impl.system;

import com.nodewebzsz.dao.entity.SystemConfig;
import com.nodewebzsz.dao.repository.SystemConfigRepository;
...
import com.nodewebzsz.ociserver.pojo.request.ApiTokenConfig;
import com.nodewebzsz.ociserver.pojo.request.ApiTokenConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.CloudflareConfig;
import com.nodewebzsz.ociserver.pojo.request.CloudflareConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.EdgeOneConfig;
import com.nodewebzsz.ociserver.pojo.request.EdgeOneConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.FeishuConfig;
import com.nodewebzsz.ociserver.pojo.request.FeishuConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.GoogleConfig;
import com.nodewebzsz.ociserver.pojo.request.GoogleConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.MfaConfig;
import com.nodewebzsz.ociserver.pojo.request.MfaConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.ProxyConfig;
import com.nodewebzsz.ociserver.pojo.request.ProxyConfigRequest;
import com.nodewebzsz.ociserver.pojo.response.ApiTokenResponse;
import com.nodewebzsz.ociserver.service.message.factory.MessageFactory;
import com.nodewebzsz.ociserver.pojo.request.BarkConfig;
import com.nodewebzsz.ociserver.pojo.request.BarkConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.DingTalkConfig;
import com.nodewebzsz.ociserver.pojo.request.DingTalkConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.GithubConfig;
import com.nodewebzsz.ociserver.pojo.request.GithubConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.IpCheckConfig;
import com.nodewebzsz.ociserver.pojo.request.IpCheckConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.TaskConfig;
import com.nodewebzsz.ociserver.pojo.request.TaskConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.TelegramConfig;
import com.nodewebzsz.ociserver.pojo.request.TelegramConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.TurnstileConfig;
import com.nodewebzsz.ociserver.pojo.request.TurnstileConfigRequest;
import com.nodewebzsz.ociserver.pojo.request.VPSConfig;
import com.nodewebzsz.ociserver.pojo.request.VPSConfigRequest;
import com.nodewebzsz.ociserver.config.task.DynamicIpCheckTask;
...
public class SystemConfigService {
    ...
    public boolean validateApiToken(String token) {
        if (StringUtils.isEmpty(token) || !token.startsWith("oci-pool_api_")) {
            return false;
        }
        ...
        try {
            ...
            // 验证签名
            String tokenBody = token.substring(13); // 移除 "oci-pool_api_"
    ...
    private String generateApiToken() {
        try {
            ...
            return "oci-pool_api_" + Base64.getUrlEncoder().withoutPadding().encodeToString(payload.getBytes()) + "." + signatureBase64;
