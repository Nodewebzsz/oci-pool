package com.nodewebzsz.ociserver.utils.oracle.db;
...
import static com.nodewebzsz.ociserver.utils.oracle.OciComputerUtils.buildSimpleAllNetWork;
...
public class OciDbUtils {
    ...
    public static final String DEFAULT_MYSQL_NLB_DISPLAY_NAME = "OCI_POOL_MYSQL_NLB";
    public static final String DEFAULT_MYSQL_NAME = "OCI_POOL_MYSQL_FREE";
    ...
    * @Description: resetMysqlPassword
     * 重置数据库密码
    * @Param: [com.nodewebzsz.dao.entity.Tenant, java.lang.String, java.lang.String]
    * @return: void
    * @Author: nodewebzsz
    ...
    * @return: java.util.List<com.nodewebzsz.dao.entity.DbConfig>
    * @Author: nodewebzsz
    * @Date: 1/1/26 7:09 AM
    */
    ...
    * @Description: createMysqlDbSystemAndNlb
     * 一键创建mysql并返回公网ip
    * @Param: [com.nodewebzsz.dao.entity.Tenant, java.lang.String, java.lang.String, java.lang.String]
    ...
    * @Param: [com.nodewebzsz.dao.entity.Tenant, com.nodewebzsz.dao.entity.DbConfig]
    * @return: void
    * @Author: nodewebzsz
    * @Date: 1/1/26 8:03 PM
    */
