package com.nodewebzsz.ociserver.utils.oracle;

import com.alibaba.fastjson2.JSON;
import com.nodewebzsz.dao.entity.Tenant;
import com.nodewebzsz.ociserver.config.constant.SystemScriptShell;
import com.nodewebzsz.ociserver.config.exception.OciExceptionFactory;
import com.nodewebzsz.ociserver.pojo.domain.dto.User;
import com.nodewebzsz.ociserver.pojo.dto.OciComputerDto;
import com.nodewebzsz.ociserver.pojo.dto.OciGatewayVcnPair;
import com.nodewebzsz.ociserver.pojo.enums.ArchitectureEnum;
import com.nodewebzsz.ociserver.pojo.enums.OperationSystemEnum;
import com.nodewebzsz.ociserver.pojo.request.OciComputerCreateRequest;
...
import static com.nodewebzsz.ociserver.config.exception.ErrorCode.NOT_AUTH;
import static com.nodewebzsz.ociserver.service.oracle.OracleCloudService.addInternetGatewayToDefaultRouteTable;
import static com.nodewebzsz.ociserver.service.oracle.OracleCloudService.createInternetGateway;
import static com.nodewebzsz.ociserver.service.oracle.OracleCloudService.createSubnet;
import static com.nodewebzsz.ociserver.service.oracle.OracleCloudService.findRootCompartment;
import static com.nodewebzsz.ociserver.service.oracle.OracleCloudService.getAvailabilityDomains;
import static com.nodewebzsz.ociserver.utils.oracle.OciCliUtils.addNetworkSecurityGroupSecurityRules;
import static com.nodewebzsz.ociserver.utils.oracle.OciCliUtils.createNetworkSecurityGroup;
import static com.nodewebzsz.ociserver.utils.oracle.OciCliUtils.createVcn;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.checkShapes;
...
public class OciComputerUtils {
    ...
    * @Param: [com.nodewebzsz.ociserver.pojo.dto.OciComputerDto, com.nodewebzsz.ociserver.pojo.domain.dto.User]
    * @return: void
    * @Author: 抢占实例
    ...
    * @Description: buildSimpleAllNetWork
     * 构建一个网络信息组(不做镜像的事情)
    * @Param: [com.nodewebzsz.dao.entity.Tenant]
    * @return: com.nodewebzsz.ociserver.pojo.dto.OciComputerDto.AvailabilityDomainName
    * @Author: nodewebzsz
    ...
    * @Param: [java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, com.nodewebzsz.ociserver.pojo.domain.dto.User]
