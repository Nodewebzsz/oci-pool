...
import static com.nodewebzsz.ociserver.utils.oracle.VCNFlowLogsUtils.getVcnSubnets;
...
public class OciUtils {
    ...
    public static final String DEFAULT_PASSWD = "OciPool2026";
     ...
     * @Param: [com.nodewebzsz.ociserver.domain.Tenant]
