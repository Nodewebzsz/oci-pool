package com.nodewebzsz.ociserver.utils.oracle.vnic;
...
import static com.nodewebzsz.ociserver.config.constant.SystemScriptShell.subnetName;
import static com.nodewebzsz.ociserver.service.oracle.OracleCloudService.findRootCompartment;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.createOrUpdateSubnet;
import static com.nodewebzsz.ociserver.utils.oracle.OciUtils.findCompartmentList;
...
public class VnicManagementUtils {
    ...
    private static String genHostName() {
        String baseHostname = "oci-pool-hn";
    ...
    * @return: java.util.List<com.nodewebzsz.ociserver.utils.oracle.vnic.VnicCreationResult>
    * @Author: nodewebzsz
