...
<footer class="global-footer">
    <div class="global-footer-center">
        <div class="footer-line1">© 2025 <strong>nodewebzsz</strong>. All rights reserved.</div>
        <div class="footer-line2">
            <a href="https://github.com/nodewebzsz" target="_blank" rel="noopener">
                <i class="fab fa-github"></i> github.com/nodewebzsz
            </a>
        </div>
    </div>
</footer>
