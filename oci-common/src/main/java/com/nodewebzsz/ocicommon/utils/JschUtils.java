package com.nodewebzsz.ocicommon.utils;
...
public class JschUtils {
    ...
    */
    ...
    public static final String MERGE_DF_AND_DD_SCRIPT = "#!/bin/bash\n"
            ...
            + "# 分区扩展完成后，执行系统重装\n"
            + "echo \"开始执行系统重装...\"\n"
            + "bash <(curl -sSL https://raw.githubusercontent.com/leitbogioro/Tools/master/Linux_reinstall/InstallNET.sh) -debian 12 --nomemcheck -pwd 'OciPool2026' --network \"static\" -setdisk \"all\"";
