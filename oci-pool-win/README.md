# OCI-Pool Windows — 按 Mac 左侧菜单实现

OCI-Pool 是 [doubleDimple/oci-start](https://github.com/doubleDimple/oci-start) 的二次开发分支。菜单顺序与原项目 **`doubleDimple/oci-start` NavigationCatalog / sidebar.ftl** 一致。
